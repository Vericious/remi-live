...
import { FEED_URL } from './feed-config.js';
...
export function projectGithubUrl(projectName) {
  const known = {
...
export function buildProjectStats(feed) {
  const byProject = {};
...
export function updateHeroStats(feed) {
...
// Boot — only in a browser with the required DOM elements
if (typeof document !== 'undefined' && document.getElementById('projectsGrid')) {
